		...
		<div class="titContainer">
	        ...
	        <div class="menuInt">
	        	<ul>
	            	...
	            	><a href="comun-articulos-manager"><span><img src="/web/img/menuPointArticles.png" width="24" height="22" alt="<spring:message code="comun.articulos"/>" /></span><spring:message code="comun.articulos"/></a></li>
				    <li <% if (path.indexOf("comentarios")!=-1){ %> class="selected" <%}%>
	            	><a href="comun-comentarios-manager"><span><img src="/web/img/menuPointComments.png" width="23" height="20" alt="<spring:message code="comun.comentarios"/>" /></span><spring:message code="comun.comentarios"/></a></li>
				</ul>
	        </div>