	        ...
	        <div class="menuInt">
	        	<ul>
				   <li <% if (path.indexOf("articulos")!=-1){ %> class="selected" <%}%>
	            	><a href="salud-articulos-manager"><span><img src="/web/img/menuPointArticles.png" width="24" height="22" alt="<spring:message code="salud.articulos"/>" /></span><spring:message code="salud.articulos"/></a></li>
				   <li <% if (path.indexOf("comentarios")!=-1){ %> class="selected" <%}%>
	            	><a href="salud-comentarios-manager"><span><img src="/web/img/menuPointComments.png" width="23" height="20" alt="<spring:message code="salud.comentarios"/>" /></span><spring:message code="salud.comentarios"/></a></li>
				</ul>
	        </div>