...
<%@include file="CabeceraArte.jsp"%>
		...
		<div class="textHome art">
	            ...
	            <% if (eventoBean.getEveImagen()!=null && eventoBean.getEveImagen()!=""){ %><div class="imgCaption"><img src="../../imageServe?objectId=<%=eventoBean.getEveImagen()%>&fileName=<%=eventoBean.getEveImagenName()%>&x=230&y=171" class="sectionMainPict" /></div><% } %>
